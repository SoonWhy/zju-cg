...
// milky's texture and display list id
const char *MILKY_TEXTURE_PATH = MAKE_TEXTURE_PATH("milky_way");
GLuint MILKY_TEXTURE_NAME;
GLuint MILKY_DISPLAY_LIST;
...
void initTexture(){
    MILKY_TEXTURE_NAME=loadTexture(MILKY_TEXTURE_PATH);
...
void initMilkyDisplay(){
    ...
    MILKY_DISPLAY_LIST=glGenLists(1);
    glNewList(MILKY_DISPLAY_LIST, GL_COMPILE);
    
    glPushAttrib(GL_ENABLE_BIT | GL_TEXTURE_BIT);

    glEnable(GL_TEXTURE_2D);
    glBindTexture(GL_TEXTURE_2D, MILKY_TEXTURE_NAME);
